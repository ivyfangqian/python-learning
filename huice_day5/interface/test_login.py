...
#     suite.addTest(LoginTest("test_type_null"))
#     suite.addTest(LoginTest("test_postid_null"))
#     suite.addTest(LoginTest("test_type_error"))
#     suite.addTest(LoginTest("test_postid_error"))
#
#     html_file = "d:\\test\\res"+ time.strftime("%Y%m%d%H%M%S") +".html"
#     fp = file(html_file,"wb")
#     runner = HTMLTestRunner(fp,title=u"登录信息测试报告",description=u"登录用例测试情况")
#     runner.run(suite)
